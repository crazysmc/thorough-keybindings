...
public enum HardcodedMappingImpl implements HardcodedMapping
{
  ...
  HOTBAR_1("key.hotbar.1", KEY_1, "key.categories.inventory"),
  HOTBAR_2("key.hotbar.2", KEY_2, "key.categories.inventory"),
  HOTBAR_3("key.hotbar.3", KEY_3, "key.categories.inventory"),
  HOTBAR_4("key.hotbar.4", KEY_4, "key.categories.inventory"),
  HOTBAR_5("key.hotbar.5", KEY_5, "key.categories.inventory"),
  HOTBAR_6("key.hotbar.6", KEY_6, "key.categories.inventory"),
  HOTBAR_7("key.hotbar.7", KEY_7, "key.categories.inventory"),
  HOTBAR_8("key.hotbar.8", KEY_8, "key.categories.inventory"),
  HOTBAR_9("key.hotbar.9", KEY_9, "key.categories.inventory"),
