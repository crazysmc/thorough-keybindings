...
public class Initializer implements ClientModInitializer
{
  private static final HardcodedMapping[] KNOWN_MAPPINGS = {
      ...
      CHARTS_PROFILER, CHARTS_FPS, CHARTS_NETWORK, RELOAD_CHUNKS, SHOW_HITBOXES, COPY_LOCATION, CLEAR_CHAT,
      CHUNK_BOUNDARIES, ADVANCED_TOOLTIPS, INSPECT, PROFILING, CREATIVE_SPECTATOR, PAUSE_FOCUS, HELP,
      DUMP_DYNAMIC_TEXTURES, RELOAD_RESOURCEPACKS, CLIENT_VERSION,
  ...
  public void onInitializeClient()
  {
    ...
    for (HardcodedMapping mapping : KNOWN_MAPPINGS)
      KeyBindingHelper.registerKeyBinding(
          new KeyRemapping(mapping, categories.getCategory(mapping.getCategory().getType())));
