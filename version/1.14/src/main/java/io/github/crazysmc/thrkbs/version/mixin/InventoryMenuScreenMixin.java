...
public abstract class InventoryMenuScreenMixin
{
  ...
  @WrapOperation(
      ...
      at = @At(
          value = "INVOKE",
          target = "Lnet/minecraft/client/gui/screen/inventory/menu/InventoryMenuScreen;hasShiftDown()Z"
      )
  )
  private boolean mouseReleased_hasShiftDown(Operation<Boolean> original)
  {
  ...
  @WrapOperation(
      ...
      at = @At(
          value = "INVOKE",
          target = "Lnet/minecraft/client/gui/screen/inventory/menu/InventoryMenuScreen;hasControlDown()Z"
      )
  )
  private boolean keyPressed_hasControlDown(Operation<Boolean> original)
  {
